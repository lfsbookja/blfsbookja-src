...
@y
    <title>&IntroductionTo1;lxqt-menu-data&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &lxqt-menu-data-size;
@z

@x
          Estimated disk space required: &lxqt-menu-data-buildsize;
@y
          &Estimateddiskspacerequired;: &lxqt-menu-data-buildsize;
@z

@x
          Estimated build time: &lxqt-menu-data-time;
@y
          &Estimatedbuildtime;: &lxqt-menu-data-time;
@z

@x
    <bridgehead renderas="sect3">lxqt-menu-data Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;lxqt-menu-data&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;lxqt-menu-data&InstallationOf2;</title>
@z
...
@x
      ...
      commands:
@y
      以下のコマンドを実行して <application>lxqt-menu-data</application> をビルドします。
@z
