...
@y
    <title>&IntroductionTo1;obconf-qt&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &obconf-qt-size;
@z

@x
          Estimated disk space required: &obconf-qt-buildsize;
@y
          &Estimateddiskspacerequired;: &obconf-qt-buildsize;
@z

@x
          Estimated build time: &obconf-qt-time;
@y
          &Estimatedbuildtime;: &obconf-qt-time;
@z

@x
    <bridgehead renderas="sect3">obconf-qt Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;obconf-qt&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;obconf-qt&InstallationOf2;</title>
@z
