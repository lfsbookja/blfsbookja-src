...
@y
          &DownloadSize;: &pcmanfm-qt-size;
@z

@x
          Estimated disk space required: &pcmanfm-qt-buildsize;
@y
          &Estimateddiskspacerequired;: &pcmanfm-qt-buildsize;
@z

@x
          Estimated build time: &pcmanfm-qt-time;
@y
          &Estimatedbuildtime;: &pcmanfm-qt-time;
@z

@x
    <bridgehead renderas="sect3">pcmanfm-qt Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;pcmanfm-qt&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;pcmanfm-qt&InstallationOf2;</title>
@z
...
@x
      ...
      commands:
@y
      以下のコマンドを実行して <application>pcmanfm-qt</application> をビルドします。
@z
