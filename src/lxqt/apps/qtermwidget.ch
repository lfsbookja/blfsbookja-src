...
@y
    <title>&IntroductionTo1;qtermwidget&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &qtermwidget-size;
@z

@x
          Estimated disk space required: &qtermwidget-buildsize;
@y
          &Estimateddiskspacerequired;: &qtermwidget-buildsize;
@z

@x
          Estimated build time: &qtermwidget-time;
@y
          &Estimatedbuildtime;: &qtermwidget-time;
@z

@x
    <bridgehead renderas="sect3">qtermwidget Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;qtermwidget&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;qtermwidget&InstallationOf2;</title>
@z
...
@x
      ...
      following commands:
@y
      以下のコマンドを実行して <application>qtermwidget</application> をビルドします。
@z
...
@x libqtermwidget5.so
            provides a terminal widget for Qt5
@y
            Qt5 向けのターミナルウィジェットを提供します。
@z
