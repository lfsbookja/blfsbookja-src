...
@y
    <title>&IntroductionTo1;lxqt-notificationd&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &lxqt-notificationd-size;
@z

@x
          Estimated disk space required: &lxqt-notificationd-buildsize;
@y
          &Estimateddiskspacerequired;: &lxqt-notificationd-buildsize;
@z

@x
          Estimated build time: &lxqt-notificationd-time;
@y
          &Estimatedbuildtime;: &lxqt-notificationd-time;
@z

@x
    <bridgehead renderas="sect3">lxqt-notificationd Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;lxqt-notificationd&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;lxqt-notificationd&InstallationOf2;</title>
@z
...
@x
      ...
      following commands:
@y
      以下のコマンドを実行して <application>lxqt-notificationd</application> をビルドします。
@z
