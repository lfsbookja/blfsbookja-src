...
@y
    <title>&IntroductionTo1;lximage-qt&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &lximage-qt-size;
@z

@x
          Estimated disk space required: &lximage-qt-buildsize;
@y
          &Estimateddiskspacerequired;: &lximage-qt-buildsize;
@z

@x
          Estimated build time: &lximage-qt-time;
@y
          &Estimatedbuildtime;: &lximage-qt-time;
@z

@x
    <bridgehead renderas="sect3">lximage-qt Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;lximage-qt&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;lximage-qt&InstallationOf2;</title>
@z
...
@x
      ...
      commands:
@y
      以下のコマンドを実行して <application>lximage-qt</application> をビルドします。
@z
