...
@y
    <title>&IntroductionTo1;pavucontrol-qt&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &pavucontrol-qt-size;
@z

@x
          Estimated disk space required: &pavucontrol-qt-buildsize;
@y
          &Estimateddiskspacerequired;: &pavucontrol-qt-buildsize;
@z

@x
          Estimated build time: &pavucontrol-qt-time;
@y
          &Estimatedbuildtime;: &pavucontrol-qt-time;
@z

@x
    <bridgehead renderas="sect3">pavucontrol-qt Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;pavucontrol-qt&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;pavucontrol-qt&InstallationOf2;</title>
@z
...
@x
       ...
       commands:
@y
       以下のコマンドを実行して <application>pavucontrol-qt</application> をビルドします。
@z
