...
@y
  <!ENTITY gnome-video-effects-time          "&LessThan1;0.1 SBU&LessThan2;">
@z

@x
    <title>Introduction to GNOME Video Effects</title>
@y
    <title>&IntroductionTo1;GNOME Video Effects&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &gnome-video-effects-size;
@z

@x
          Estimated disk space required: &gnome-video-effects-buildsize;
@y
          &Estimateddiskspacerequired;: &gnome-video-effects-buildsize;
@z

@x
          Estimated build time: &gnome-video-effects-time;
@y
          &Estimatedbuildtime;: &gnome-video-effects-time;
@z

@x
    <title>Installation of GNOME Video Effects</title>
@y
    <title>&InstallationOf1;GNOME Video Effects&InstallationOf2;</title>
@z
...
@y
      以下のコマンドを実行して <application>GNOME Video Effects</application> をビルドします。
@z
