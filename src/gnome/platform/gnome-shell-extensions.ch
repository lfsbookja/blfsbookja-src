...
@y
  <!ENTITY gnome-shell-extensions-time          "&LessThan1;0.1 SBU&LessThan2;">
@z

@x
    <title>Introduction to GNOME Shell Extensions</title>
@y
    <title>&IntroductionTo1;GNOME Shell Extensions&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &gnome-shell-extensions-size;
@z

@x
          Estimated disk space required: &gnome-shell-extensions-buildsize;
@y
          &Estimateddiskspacerequired;: &gnome-shell-extensions-buildsize;
@z

@x
          Estimated build time: &gnome-shell-extensions-time;
@y
          &Estimatedbuildtime;: &gnome-shell-extensions-time;
@z

@x
    <bridgehead renderas="sect3">GNOME Shell Extensions Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;GNOME Shell Extensions&Dependencies2;</bridgehead>
@z
...
@x
      ...
      following commands:
@y
      以下のコマンドを実行して <application>GNOME Shell Extensions</application> をビルドします。
@z
