...
@y
  <!ENTITY yelp-xsl-time          "&LessThan1;0.1 SBU&LessThan2;">
@z

@x
    <title>Introduction to Yelp XSL</title>
@y
    <title>&IntroductionTo1;Yelp XSL&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &yelp-xsl-size;
@z

@x
          Estimated disk space required: &yelp-xsl-buildsize;
@y
          &Estimateddiskspacerequired;: &yelp-xsl-buildsize;
@z

@x
          Estimated build time: &yelp-xsl-time;
@y
          &Estimatedbuildtime;: &yelp-xsl-time;
@z

@x
    <bridgehead renderas="sect3">Yelp XSL Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;Yelp XSL&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;Yelp XSL&InstallationOf2;</title>
@z
...
@x
      ...
      commands:
@y
      以下のコマンドを実行して <application>Yelp XSL</application> をビルドします。
@z
