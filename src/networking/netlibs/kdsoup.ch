...
@y
    <title>&IntroductionTo1;kdsoap&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &kdsoap-size;
@z

@x
          Estimated disk space required: &kdsoap-buildsize;
@y
          &Estimateddiskspacerequired;: &kdsoap-buildsize;
@z

@x
          Estimated build time: &kdsoap-time;
@y
          &Estimatedbuildtime;: &kdsoap-time;
@z

@x
    <bridgehead renderas="sect3">kdsoap Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;kdsoap&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;kdsoap&InstallationOf2;</title>
@z
...
@x
      ...
      commands:
@y
      以下のコマンドを実行して <application>kdsoap</application> をビルドします。
@z
