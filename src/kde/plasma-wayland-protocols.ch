...
@y
  <!ENTITY plasma-wayland-protocols-time          "&LessThan1;0.1 SBU&LessThan2;">
@z

@x
    <title>Introduction to the Plasma-wayland-protocols</title>
@y
    <title>&IntroductionTo1;Plasma-wayland-protocols&IntroductionTo2;</title>
@z

@x
      This package provides a custom set of protocol definitions for KDE.
@y
      本パッケージは KDE のプロトコル定義のカスタムセットを提供します。
@z
...
@y
          &DownloadSize;: &plasma-wayland-protocols-size;
@z

@x
          Estimated disk space required: &plasma-wayland-protocols-buildsize;
@y
          &Estimateddiskspacerequired;: &plasma-wayland-protocols-buildsize;
@z

@x
          Estimated build time: &plasma-wayland-protocols-time;
@y
          &Estimatedbuildtime;: &plasma-wayland-protocols-time;
@z

@x
    <bridgehead renderas="sect3">Plasma-wayland-protocols Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;Plasma-wayland-protocols&Dependencies2;</bridgehead>
@z
...
@y
      以下のコマンドを実行して <application>Plasma-wayland-protocols</application> をビルドします。
@z
