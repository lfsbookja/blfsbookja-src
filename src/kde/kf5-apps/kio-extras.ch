...
@y
    <title>&IntroductionTo1;kio-extras&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &kio-extras-size;
@z

@x
          Estimated disk space required: &kio-extras-buildsize;
@y
          &Estimateddiskspacerequired;: &kio-extras-buildsize;
@z

@x
          Estimated build time: &kio-extras-time;
@y
          &Estimatedbuildtime;: &kio-extras-time;
@z

@x
    <bridgehead renderas="sect3">kio-extras Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;kio-extras&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;kio-extras&InstallationOf2;</title>
@z
...
@x
      ...
      commands:
@y
      以下のコマンドを実行して <application>kio-extras</application> をビルドします。
@z
