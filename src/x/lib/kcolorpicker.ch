...
@y
  <!ENTITY kcolorpicker-time          "&LessThan1;0.1 SBU&LessThan2;">
@z

@x
    <title>Introduction to kColorPicker</title>
@y
    <title>&IntroductionTo1;kColorPicker&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &kcolorpicker-size;
@z

@x
          Estimated disk space required: &kcolorpicker-buildsize;
@y
          &Estimateddiskspacerequired;: &kcolorpicker-buildsize;
@z

@x
          Estimated build time: &kcolorpicker-time;
@y
          &Estimatedbuildtime;: &kcolorpicker-time;
@z

@x
    <bridgehead renderas="sect3">kColorPicker Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;kColorPicker&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;kColorPicker&InstallationOf2;</title>
@z
...
@y
      以下のコマンドを実行して <application>kColorPicker</application> をビルドします。
@z
