...
@y
  <!ENTITY hicolor-icon-theme-time          "&LessThan1;0.1 SBU&LessThan2;">
@z

@x
    <title>Introduction to hicolor-icon-theme</title>
@y
    <title>&IntroductionTo1;hicolor-icon-theme&IntroductionTo2;</title>
@z
...
@y
    <title>&InstallationOf1;hicolor-icon-theme&InstallationOf2;</title>
@z
