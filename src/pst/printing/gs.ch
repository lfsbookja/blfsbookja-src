...
%
@x
  <!ENTITY gs-buildsize     "291 MB (with fonts and libgs.so)">
  <!ENTITY gs-time          "1.2 SBU (Using parallelism=4; with libgs.so)">
@y
  <!ENTITY gs-buildsize     "291 MB（フォントと libgs.so）">
  <!ENTITY gs-time          "1.2 SBU（parallelism=4 指定時、libgs.so 込み）">
@z
