...
@x
  ...
  <!ENTITY cryptsetup-time          "0.2 SBU (add 8.9 SBU for tests)">
@y
  <!ENTITY cryptsetup-buildsize     "33 MB（テスト実施時はさらに 5 MB）">
  <!ENTITY cryptsetup-time          "0.2 SBU（テスト実施時はさらに 8.9 SBU）">
@z
