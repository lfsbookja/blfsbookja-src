...
@y
  <!ENTITY xdg-dbus-proxy-time          "&LessThan1;0.1 SBU&LessThan2;">
@z

@x
    <title>Introduction to xdg-dbus-proxy</title>
@y
    <title>&IntroductionTo1;xdg-dbus-proxy&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &xdg-dbus-proxy-size;
@z

@x
          Estimated disk space required: &xdg-dbus-proxy-buildsize;
@y
          &Estimateddiskspacerequired;: &xdg-dbus-proxy-buildsize;
@z

@x
          Estimated build time: &xdg-dbus-proxy-time;
@y
          &Estimatedbuildtime;: &xdg-dbus-proxy-time;
@z

@x
    <bridgehead renderas="sect3">xdg-dbus-proxy Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;xdg-dbus-proxy&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;xdg-dbus-proxy&InstallationOf2;</title>
@z
...
@x
      ...
      commands:
@y
      以下のコマンドをビルドして <application>xdg-dbus-proxy</application> をビルドします。
@z
