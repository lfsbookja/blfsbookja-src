...
@y
  <!ENTITY cups-pk-helper-time          "&LessThan1;0.1 SBU&LessThan2;">
@z

@x
    <title>Introduction to cups-pk-helper</title>
@y
    <title>&IntroductionTo1;cups-pk-helper&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &cups-pk-helper-size;
@z

@x
          Estimated disk space required: &cups-pk-helper-buildsize;
@y
          &Estimateddiskspacerequired;: &cups-pk-helper-buildsize;
@z

@x
          Estimated build time: &cups-pk-helper-time;
@y
          &Estimatedbuildtime;: &cups-pk-helper-time;
@z

@x
    <bridgehead renderas="sect3">cups-pk-helper Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;cups-pk-helper&Dependencies2;</bridgehead>
@z
...
@y
      &UserNotes;: <ulink url="&blfs-wiki;/cups-pk-helper"/>
@z

@x
    <title>Installation of cups-pk-helper</title>
@y
    <title>&InstallationOf1;cups-pk-helper&InstallationOf2;</title>
@z
...
@x
      ...
      commands:
@y
      以下のコマンドを実行して <application>cups-pk-helper</application> をビルドします。
@z
