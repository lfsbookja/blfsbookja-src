...
@y
    <title>&IntroductionTo1;sysmon-qt&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &sysmon-qt-size;
@z

@x
          Estimated disk space required: &sysmon-qt-buildsize;
@y
          &Estimateddiskspacerequired;: &sysmon-qt-buildsize;
@z

@x
          Estimated build time: &sysmon-qt-time;
@y
          &Estimatedbuildtime;: &sysmon-qt-time;
@z

@x
    <bridgehead renderas="sect3">sysmon-qt Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;sysmon-qt&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;sysmon-qt&InstallationOf2;</title>
@z
...
@x
      ...
      commands:
@y
      以下のコマンドを実行して <application>sysmon-qt</application> をビルドします。
@z
