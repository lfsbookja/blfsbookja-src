...
@y
    <title>&IntroductionTo1;duktape&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &duktape-size;
@z

@x
          Estimated disk space required: &duktape-buildsize;
@y
          &Estimateddiskspacerequired;: &duktape-buildsize;
@z

@x
          Estimated build time: &duktape-time;
@y
          &Estimatedbuildtime;: &duktape-time;
@z

@x
    <title>Installation of duktape</title>
@y
    <title>&InstallationOf1;duktape&InstallationOf2;</title>
@z
...
@x
      ...
      following commands:
@y
      以下のコマンドを実行して <application>duktape</application> をビルドします。
@z
