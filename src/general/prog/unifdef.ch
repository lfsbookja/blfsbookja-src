...
@y
  <!ENTITY unifdef-time          "&LessThan1;0.1 SBU&LessThan2;">
@z

@x
    <title>Introduction to unifdef</title>
@y
    <title>&IntroductionTo1;unifdef&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &unifdef-size;
@z

@x
          Estimated disk space required: &unifdef-buildsize;
@y
          &Estimateddiskspacerequired;: &unifdef-buildsize;
@z

@x
          Estimated build time: &unifdef-time;
@y
          &Estimatedbuildtime;: &unifdef-time;
@z

@x
    <title>Installation of unifdef</title>
@y
    <title>&InstallationOf1;unifdef&InstallationOf2;</title>
@z
...
@x
      ...
      commands:
@y
      以下のコマンドを実行して <application>unifdef</application> をビルドします。
@z
