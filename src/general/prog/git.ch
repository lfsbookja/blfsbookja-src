...
@y
  <!ENTITY git-buildsize     "500 MB（ダウンロードドキュメントを含む）">
@z

@x
  <!ENTITY git-time          "0.4 SBU (with parallelism=4; add 1.9 SBU for tests with parallelism=4)">
@y
  <!ENTITY git-time          "0.4 SBU（parallelism=4 処理時; テスト実施時はさらに 1.9 SBU）">
@z
