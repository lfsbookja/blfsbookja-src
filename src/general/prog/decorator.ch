...
@y
  <!ENTITY decorator-time          "&LessThan1;0.1 SBU&LessThan1;">
@z

@x
      <title>Introduction to decorator Module</title>
@y
      <title>&IntroductionTo1;decorator &Module;&IntroductionTo2;</title>
@z
...
@y
            &DownloadSize;: &decorator-size;
@z

@x
            Estimated disk space required: &decorator-buildsize;
@y
            &Estimateddiskspacerequired;: &decorator-buildsize;
@z

@x
            Estimated build time: &decorator-time;
@y
            &Estimatedbuildtime;: &decorator-time;
@z
...
@y
      <title>&InstallationOf1;decorator&InstallationOf2;</title>
@z
