...
@x
  <!ENTITY vala-buildsize     "173 MB (add 2 MB for tests)">
  <!ENTITY vala-time          "0.3 SBU (using parallelism=4; add 2.1 SBU for tests)">
@y
  <!ENTITY vala-buildsize     "173 MB (テスト実施時はさらに 2 MB)">
  <!ENTITY vala-time          "0.3 SBU (parallelism=4 利用時。テスト実施時はさらに 2.1 SBU)">
@z
