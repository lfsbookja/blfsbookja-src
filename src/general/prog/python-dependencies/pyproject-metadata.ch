...
@y
      <title>&IntroductionTo1;Pyproject-Metadata モジュール&IntroductionTo1;</title>
@z
...
@y
            &DownloadSize;: &pyproject-metadata-size;
@z

@x
            Estimated disk space required: &pyproject-metadata-buildsize;
@y
            &Estimateddiskspacerequired;: &pyproject-metadata-buildsize;
@z

@x
            Estimated build time: &pyproject-metadata-time;
@y
            &Estimatedbuildtime;: &pyproject-metadata-time;
@z

@x
      <bridgehead renderas="sect4">Pyproject-Metadata Dependencies</bridgehead>
@y
      <bridgehead renderas="sect4">&Dependencies1;Pyproject-Metadata&Dependencies2;</bridgehead>
@z
...
@y
      <title>&InstallationOf1;Pyproject-Metadata&InstallationOf2;</title>
@z
...
@y
          ...
          <seg>&None;</seg>
          <seg>
            /usr/lib/python&python3-majorver;/site-packages/pyproject_metadata,
            /usr/lib/python&python3-majorver;/site-packages/pyproject_metadata-&pyproject-metadata-version;.dist-info
          </seg>
@z
