...
@y
  <!ENTITY pyatspi2-time          "&LessThan1;0.1 SBU&LessThan2;">
@z

@x
      <title>Introduction to PyAtSpi2</title>
@y
      <title>&IntroductionTo1;PyAtSpi2&IntroductionTo2;</title>
@z
...
@y
            &DownloadSize;: &pyatspi2-size;
@z

@x
            Estimated disk space required: &pyatspi2-buildsize;
@y
            &Estimateddiskspacerequired;: &pyatspi2-buildsize;
@z

@x
            Estimated build time: &pyatspi2-time;
@y
            &Estimatedbuildtime;: &pyatspi2-time;
@z

@x
      <bridgehead renderas="sect4">PyAtSpi2 Dependencies</bridgehead>
@y
      <bridgehead renderas="sect4">&Dependencies1;PyAtSpi2&Dependencies2;</bridgehead>
@z
...
@y
      <title>&InstallationOf1;PyAtSpi2&InstallationOf2;</title>
@z
