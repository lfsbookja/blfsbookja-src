...
@y
  <!ENTITY py3c-time          "&LessThan1;0.1 SBU&LessThan2; (テスト込み)">
@z

@x
      <title>Introduction to Py3c</title>
@y
      <title>&IntroductionTo1;Py3c&IntroductionTo2;</title>
@z
...
@y
            &Estimateddiskspacerequired;: &py3c-buildsize;
@z

@x
            Estimated build time: &py3c-time;
@y
            &Estimatedbuildtime;: &py3c-time;
@z

@x
      <title>Installation of Py3c</title>
@y
      <title>&InstallationOf1;Py3c&InstallationOf2;</title>
@z
