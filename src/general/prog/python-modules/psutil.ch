...
@y
      <title>&IntroductionTo1;psutil モジュール&IntroductionTo2;</title>
@z
...
@y
            &DownloadSize;: &psutil-size;
@z

@x
            Estimated disk space required: &psutil-buildsize;
@y
            &Estimateddiskspacerequired;: &psutil-buildsize;
@z

@x
            Estimated build time: &psutil-time;
@y
            &Estimatedbuildtime;: &psutil-time;
@z

@x
      <title>Installation of psutil</title>
@y
      <title>&InstallationOf1;psutil&InstallationOf2;</title>
@z
