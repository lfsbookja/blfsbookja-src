...
@y
  <!ENTITY pygments-time          "&LessThan1;0.1 SBU&LessThan2;">
@z

@x
      <title>Introduction to Pygments Module</title>
@y
      <title>&IntroductionTo1;Pygments &Module;&IntroductionTo2;</title>
@z
...
@x
        ...
        languages.
@y
        <application>Pygments</application> は <application>Python</application> によって書かれた汎用的なシンタックスハイライトモジュールです。
        300 以上の言語に対応しています。
@z
...
@y
            &DownloadSize;: &pygments-size;
@z

@x
            Estimated disk space required: &pygments-buildsize;
@y
            &Estimateddiskspacerequired;: &pygments-buildsize;
@z

@x
            Estimated build time: &pygments-time;
@y
            &Estimatedbuildtime;: &pygments-time;
@z

@x
        User Notes: <ulink url="&blfs-wiki;/pygments"/>
@y
        &UserNotes;: <ulink url="&blfs-wiki;/pygments"/>
@z

@x
      <title>Installation of Pygments</title>
@y
      <title>&InstallationOf1;Pygments&InstallationOf2;</title>
@z
...
@y
        この <application>Python 3</application> モジュールをビルドしインストールするには、<systemitem
