...
@y
    <title>&IntroductionTo1;Xfce4 Pulseaudio Plugin&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &xfce4-pulseaudio-plugin-size;
@z

@x
          Estimated disk space required: &xfce4-pulseaudio-plugin-buildsize;
@y
          &Estimateddiskspacerequired;: &xfce4-pulseaudio-plugin-buildsize;
@z

@x
          Estimated build time: &xfce4-pulseaudio-plugin-time;
@y
          &Estimatedbuildtime;: &xfce4-pulseaudio-plugin-time;
@z

@x
    <bridgehead renderas="sect3">Xfce4 Pulseaudio Plugin Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;Xfce4 Pulseaudio Plugin&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;Xfce4 Pulseaudio Plugin&InstallationOf2;</title>
@z
...
@y
      以下のコマンドを実行して <application>Xfce4 Pulseaudio Plugin</application> をビルドします。
@z
