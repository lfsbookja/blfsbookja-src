...
@y
    <title>&IntroductionTo1;Xfce4 Terminal&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &xfce4-terminal-size;
@z

@x
          Estimated disk space required: &xfce4-terminal-buildsize;
@y
          &Estimateddiskspacerequired;: &xfce4-terminal-buildsize;
@z

@x
          Estimated build time: &xfce4-terminal-time;
@y
          &Estimatedbuildtime;: &xfce4-terminal-time;
@z

@x
    <bridgehead renderas="sect3">Xfce4 Terminal Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;Xfce4 Terminal&Dependencies2;</bridgehead>
@z
...
@y
      &UserNotes;: <ulink url="&blfs-wiki;/xfce4-terminal"/>
@z

@x
    <title>Installation of Xfce4 Terminal</title>
@y
    <title>&InstallationOf1;Xfce4 Terminal&InstallationOf2;</title>
@z
...
@x
      ...
      commands:
@y
      以下のコマンドを実行して <application>Xfce4 Terminal</application> をビルドします。
@z
