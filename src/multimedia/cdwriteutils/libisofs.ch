...
@y
    <title>&IntroductionTo1;libisofs&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &libisofs-size;
@z

@x
          Estimated disk space required: &libisofs-buildsize;
@y
          &Estimateddiskspacerequired;: &libisofs-buildsize;
@z

@x
          Estimated build time: &libisofs-time;
@y
          &Estimatedbuildtime;: &libisofs-time;
@z

@x
    <bridgehead renderas="sect3">libisofs Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;libisofs&Dependencies2;</bridgehead>
@z
...
@y
    <title>&InstallationOf1;libisofs&InstallationOf2;</title>
@z
...
@x
      ...
      commands:
@y
      以下のコマンドを実行して <application>libisofs</application> をビルドします。
@z
...
@y
            <application>libisofs</application> API 関数を提供します。
@z
