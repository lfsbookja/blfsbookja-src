...
@y
    <title>&IntroductionTo1;Xine ライブラリ&IntroductionTo2;</title>
@z
...
@y
          &DownloadSize;: &xine-lib-size;
@z

@x
          Estimated disk space required: &xine-lib-buildsize;
@y
          &Estimateddiskspacerequired;: &xine-lib-buildsize;
@z

@x
          Estimated build time: &xine-lib-time;
@y
          &Estimatedbuildtime;: &xine-lib-time;
@z

@x
    <bridgehead renderas="sect3">Xine Libraries Dependencies</bridgehead>
@y
    <bridgehead renderas="sect3">&Dependencies1;Xine ライブラリ&Dependencies2;</bridgehead>
@z
...
@y
    ...
    <para role="optional">
      ...
      <ulink url="https://www.theora.org">libtheora</ulink>,
      <ulink url="https://www.musepack.net/">musepack</ulink>,
      <ulink url="&gnu-http;/vcdimager/">VCDImager</ulink>,
      <ulink url="https://www.wavpack.com/">WavPack</ulink>,
    </para>
@z
...
@y
    <title>&InstallationOf1;Xine ライブラリ&InstallationOf2;</title>
@z
...
@x
      ...
      commands:
@y
      以下のコマンドを実行して <application>Xine ライブラリ</application> をビルドします。
@z
...
@y
        <seg>xine-config, xine-list-1.2</seg>
        <seg>libxine.so and numerous plugin modules and video extensions under
          /usr/lib/xine/plugins/2.8</seg>
        <seg>
          Output display engine fonts located in /usr/share/xine-lib/fonts
